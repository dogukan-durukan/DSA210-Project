...
The data will be retrieved directly from Kaggle and processed using the **Python Pandas** library for structured analysis.

## 3. Data Characteristics and Enrichment
The primary dataset provides granular operational details but lacks market context. To satisfy the project's enrichment requirement, the operational data will be **enriched** by joining it with the second dataset based on "Origin" and "Destination" pairs (Route level). This integration allows for the mapping of each flight’s delay performance to the specific airline’s market share and average pricing on that route.
...
* **Exploratory Data Analysis (EDA):** Visualizing delay distributions across different airlines and routes using Matplotlib and Seaborn.
...
* **Machine Learning:** Implementing a Linear Regression model to predict delay minutes based on features such as market share and airline carrier performance.

---
*Note: AI tools (Gemini) were used to structure this project proposal in accordance with academic integrity guidelines.*
